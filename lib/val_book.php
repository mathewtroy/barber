...
// Check address
     ...
     * 
     * 
     * @param string $address The `string` being measured for length.
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valAddressMin ($address) {
     ...
     * 
     */
    function valAddressMax ($address) {
     ...
     * 
     * 
     * @param string $address The `string` contains input
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valAddressPattern ($address) {
...
// Check location 
     ...
     * 
     * 
     * @param string $location The `string` being measured for length.
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valLocationMin ($location) {
        return strlen($location) >= 4;
    }
     ...
     * 
     */
    function valLocationMax ($location) {
        return strlen($location) <= 20;
    }
     ...
     * 
     * 
     * @param string $location The `string` contains input
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valLocationPattern ($location) {
...
// Check persons
     ...
     * 
     * 
     * @param string $guests The `string` being measured for length.
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valGuestsMin ($guests) {
        return $guests >= 1;
    }
...
// Check days
     ...
     * 
     * 
     * @param string $days The `string` being measured for length.
     * @return bool `True` if the `string` on success,
     * and `False` if the `string` is not success.
     * 
     */
    function valDaysMin ($days) {
        return $days >= 1;
    }
